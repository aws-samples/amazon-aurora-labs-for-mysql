...
<span class="image">![IAM Policy Content](../../modules/connect-serverless/1-iam-policy-json.png?raw=true)</span>
...
<span class="image">![Code Function](../../modules/connect-serverless/2-lambda-code.png?raw=true)</span>
